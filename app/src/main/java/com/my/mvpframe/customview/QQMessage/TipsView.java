...
public class TipsView extends FrameLayout {
    ...
    public void attach(final View attachView, final Func<View> copyViewCreator, final Listener listener) {
        attachView.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                float cx=x - tipImageView.getWidth() / 2;
                float cy=y - tipImageView.getHeight() / 2;
                tipImageView.setX(cx);
                tipImageView.setY(cy);
                invalidate();
                return true;
            }
        });
    ...
    public void shakeAnimation(Point end) {
        ...
        ObjectAnimator animx = ObjectAnimator .ofFloat(tipImageView, "translationX", x);
        animx.setInterpolator(new CycleInterpolator(1));
        ObjectAnimator animy = ObjectAnimator .ofFloat(tipImageView, "translationY", y);
